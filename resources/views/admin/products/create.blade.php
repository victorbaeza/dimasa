        ...
        <div class="ibox">
          ...
          <div class="ibox-content">
            ...
            <div class="form-group  row">
              ...
              <div class="col-lg-8">
                <div class="input-group">
                  <input type="number" class="form-control" name="buy_price" min="0" step="0.01" value="{{ old('buy_price') }}" required>
                </div>
              </div>
            </div>
            ...
            <div class="form-group  row">
              ...
              <div class="col-lg-8">
                <div class="input-group">
                  <input type="number" class="form-control" name="price_comparison" min="0" step="0.01" value="{{ old('price_comparison') }}">
                </div>
              </div>
            </div>
            <div class="form-group  row">
              ...
              <div class="col-lg-8">
                <div class="input-group">
                  <input type="number" class="form-control" name="price" min="0" step="0.01" value="{{ old('price') }}" required>
                </div>
              </div>
            </div>
            ...
            <div class="form-group  row">
              ...
              <div class="col-lg-8">
                <div class="input-group">
                  <input type="number" class="form-control" name="VAT" min="0" step="0.01" value="{{ old('VAT') }}" required>
                </div>
              </div>
            </div>
            ...
            <div class="form-group  row">
              ...
              <div class="col-lg-8">
                <div class="input-group">
                  <input type="number" class="form-control" name="stock" step="1" value="{{ old('stock') }}">
                </div>
              </div>
            </div>
        ...
        <div class="ibox">
          ...
          <div class="ibox-content">
            ...
            <div class="form-group  row">
              ...
              <div class="col-lg-8">
                <div class="input-group">
                  <input type="text" class="form-control" name="sku" placeholder="Código SKU del producto" value="{{ old('sku') }}">
                </div>
              </div>
            </div>
            ...
            <div class="form-group  row">
              ...
              <div class="col-lg-8">
                <div class="input-group">
                  <input type="text" class="form-control" name="ean_code" placeholder="Código EAN/IBN del producto" value="{{ old('ean_code') }}">
                </div>
              </div>
            </div>
            ...
            <div class="form-group row justify-content-md-center mt-5">
              <div class="custom-file col-lg-10">
                  <input id="photo" type="file" class="custom-file-input" name="image" accept="image/png, image/jpg, image/jpeg"  value="{{ old('image') }}">
